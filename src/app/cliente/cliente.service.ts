...
export class ClienteService {
  ...
  cli1: Cliente = new ClienteLocador(1, 'Ana Silva', 776325413, '(83) 9663-0456', 'ana.silva@gmail.com','Motorista', this.end1, TipoCliente.LOCADOR , '1086003541')
  cli2: Cliente = new ClienteLocador(2, 'Gilvan Pereira', 476383930, '(83) 9602-2464', 'gilvan@gmail.com','Motorista', this.end2,TipoCliente.LOCADOR, '982873672')
  cli3: Cliente = new ClienteLocador(3, 'Carlos Alves',72378203, '(83) 8689-8268', 'carlos@gmail.com','Motorista', this.end3, TipoCliente.LOCADOR, '8738783299')
  cli4: Cliente = new ClienteLocador(4, 'Eduardo Lobo', 90824893, '(83) 8181-8844', 'eduardo@gmail.com','Motorista', this.end4,TipoCliente.LOCADOR, '048463830')
  cli5: Cliente = new ClienteLocador(5, 'Felipe Cordeiro', 836528309, '(83) 8738-8390', 'felipe@gmail.com','Motorista', this.end5, TipoCliente.LOCADOR, '94736483')
  cli6: Cliente = new ClienteLocador(6, 'Elder Pinelli', 768293865, '(81) 9216-3861', 'elder@gmail.com','Motorista', this.end6, TipoCliente.LOCADOR , '98463649')
  cli7: Cliente = new ClienteLocador(7, 'Vitor Santana', 436398473, '(83) 9932-2611', 'vitor@gmail.com','Motorista', this.end7, TipoCliente.LOCADOR, '098328738')
  cli8: Cliente = new ClienteLocador(8, 'Lucas Fonseca', 84739092, '(83) 4047-0456', 'lucas@gmail.com','Motorista', this.end8, TipoCliente.LOCADOR, '0974692337')
